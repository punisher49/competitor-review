...
import CompetitorsCategories from "./CompetitorsCategories";
import BabyFoodMarkets from "./BabyFoodMarkets";
...
export default connect(mapStateToProps, null)(InsightsNavbarWithCountriesAndCategories);
